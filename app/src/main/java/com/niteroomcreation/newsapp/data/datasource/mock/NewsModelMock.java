...
/**
 * how the news item data looks like in JSON format:
 * {
 * "id" : 0,
...
public class NewsModelMock {

    public static final String TAG = NewsModelMock.class.getSimpleName();

    private Random random;

    public NewsModelMock() {
        random = new Random();
        initListNewsImages();
        initListUserImages();
        initListNewsTitle();
    ...
    public List<NewsModel> getFakeListNews() {


        List<NewsModel> data = new ArrayList<>();
        for (int index = 0; index < 30; index++) {

//            NewsModel item = new NewsModel(index,
//                    getRandomNewsTitle(),
//                    getRandomUsername(),
//                    getRandomNewsImage(),
//                    getRandomUserImage(),
...
//                    generateViewType(index));
    ...
    public List<NewsModel> getRandomSortListNews() {
        // If running on Java 6 or older, use `new Random()` on RHS here
        List<NewsModel> data = getFakeListNews();
     ...
     */
    public NewsModel generateRandomNewsItem() {

//        NewsItem item = new NewsItem(-1
//                , getRandomNewsTitle()
//                , getRandomUsername()
//                , getRandomNewsImage()
//                , getRandomUserImage()
...
//                , 0);
        ...
        NewsModel item = new NewsModel(-1
                , getRandomNewsTitle()
                , getRandomContent()
                , getRandomUsername()
                , getRandomNewsImage()
